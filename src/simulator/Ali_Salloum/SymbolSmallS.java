 ...
 * and SmallCase and override their methods: move(), die(), escape(), upgrade(),
...
public class SymbolSmallS extends Symbol implements Passive, SmallCase {
	 ...
	 * @param sightDistance
	 */
	public SymbolSmallS(int idSymbol, int numberIterationsAlive, int sightDistance) {
	 ...
	 * @param sightDistance
	 */
	public SymbolSmallS(int idSymbol, Position position, int numberIterationsAlive, int sightDistance) {
		this.idSymbol = idSymbol;
		Symbol.COUNT_SYMBOLS++;
	 ...
	 * @param position
	 */
	public SymbolSmallS(Position position) {
	...
	public void upgrade() {
		...
		this.die();
		SymbolCapitalS symbolCapitalS = new SymbolCapitalS(position, age);
		Simulator.world.get(position).add(symbolCapitalS);
	}
	...
	public void moveBreed() {
		for (Symbol symbol : getMainList()) {
			if (symbol instanceof SymbolSmallS && !this.equals(symbol)) {
